...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.difficulty_button = Button(self, "easy or hard? press E or H")
    ...
    def _check_keydown_events(self, event):
        ...
        if event.key == pygame.K_RIGHT:
            ...
            if self.hs < self.stats.high_score:
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien.rect.y = 5 + alien.rect.height + 2 * alien.rect.height * row_number
